...
public class LambdaComparatorExample {
    public void lComparatorExample() {
        ...
        for (Person person : listOfPerson) {
            System.out.println(" Without lambda expression. Person name : " + person.getName());
        }
        ...
        System.out.println(" Sort persons by age in ascending order, with lambda expression.");
        listOfPerson.forEach(
                (person) -> System.out.println("Without lambda expression. Person name : " + person.getName()));
    }
}
